...
const CategoryBlogs = () => {
    ...
    return (
        <>
        <Header />
        <h1 className="text-4xl font-bold mb-6 text-center text-gray-700 mt-32">Results for: {category}</h1>
        <div className="max-w-7xl mx-auto px-4 py-8">
            {/* <h1 className="text-3xl font-bold mb-6 text-center text-gray-700">Blog Posts</h1> */}
